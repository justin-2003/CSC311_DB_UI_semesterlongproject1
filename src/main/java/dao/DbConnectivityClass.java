...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMPS";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://justin03@cscs311coursesamj03";//update this server name
        final static String DB_URL = "jdbc:mysql://justin03@cscs311coursesamj03/"+DB_NAME;//update this database name
        final static String USERNAME = "justin03@cscs311coursesamj03";// update this username
